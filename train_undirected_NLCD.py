...
obj = NLCD(laplacian_mat, init_vec, community_k, iter_num)
...
# save train labels ##############################################################
train_labels_file_name = r"\{}_NLCD_train_labels_5.txt".format(dataset_name)
...
metric_score_txt = r"\{}_NLCD_metric_score_5.txt".format(dataset_name)
