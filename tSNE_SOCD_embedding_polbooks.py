...
file_txt = r"output\{}\SOCD_embedding_matrix_5.txt".format(dataset_name)
...
save_dir = r"D:\workspace\Paper_Workspace\Community_Workspace\Knowledge_Based_Systems\els-cas-templates\Figs\tSNE_SOCD_polbooks.eps"
